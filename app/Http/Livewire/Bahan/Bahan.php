...
class Bahan extends Component
{
    ...
    public function render()
    {
        ...
        $data = ModelsBahan::select('bahans.id', 'nama_barang', 'satuan', 'nama_kategori')
        ...
        return view('livewire.bahan.bahan', compact('data', 'dataKategori'))
    ...
    public function edit($id)
    {
        ...
        $data = ModelsBahan::where('id',$id)->first();
        $this->dataId = $id;
    ...
    public function update()
    {
        ...
        if ($this->dataId) {
            $data = ModelsBahan::findOrFail($this->dataId);
            $data->update([
				'id_kategori'		=> $this->id_kategori,
                'nama_barang'       => $this->nama_barang,
                'satuan'            => $this->satuan,
    ...
    {
        $data = ModelsBahan::findOrFail($this->idRemoved);
        $data->delete();
        $this->resetInputFields();
    }
