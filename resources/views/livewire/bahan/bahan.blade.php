<div>
    <div class="section-header tw-rounded-lg tw-text-black lg:tw-hidden">
        <h4 class="tw-text-lg">Bahan</h4>
    </div>

    <div class="section-body lg:tw-mt-[-30px]">
        <div class="tw-mt-[-10px] mb-3">
            <h6 class="section-title tw-text-sm">Data Bahan</h6>
            ...
            <div class="col-lg-9">
                <div class="card card-primary">
                    <div class="card-header">
                        <h4 class="tw-text-xl tw-text-black tw-font-bold tw-font-roboto">Data Bahan</h4>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="tw-bg-white tw-border-b hover:tw-bg-gray-50 text-center">
                                        ...
                                        <td class="p-3 text-center">
                                            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#ubahDataModal" wire:click="edit({{ $row->id }})">
