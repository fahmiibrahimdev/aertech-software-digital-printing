<div>
    <div class="section-header tw-rounded-lg tw-text-black lg:tw-hidden">
        <h4 class="tw-text-lg">Customer</h4>
    </div>

    <div class="section-body lg:tw-mt-[-30px]">
        <div class="tw-mt-[-10px] mb-3">
            <h6 class="section-title tw-text-sm">Data Customer</h6>
            <p class="section-lead tw-text-xs">Customer.</p>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" wire:model="no_telepon" id="no_telepon" class="form-control">
                            </div>
							<div class="form-group">
                            ...
                            <table class="tw-table-fixed tw-w-full tw-text-black tw-text-sm tw-border-t mt-4">
                                ...
                                <tbody>
                                    ...
                                    <tr class="tw-bg-white tw-border-b hover:tw-bg-gray-50">
                                        <td class="p-3">{{ $row->nama_level }}</td>
