<div>
    <div class="section-header tw-rounded-lg tw-text-black">
        <h4 class="tw-text-lg">Dashboard | {{ \Carbon\Carbon::createFromFormat('Y-m-d', $bulanSekarang)->isoFormat('dddd, D MMMM Y') }} &mdash; {{ \Carbon\Carbon::createFromFormat('Y-m-d', $bulanDepan)->isoFormat('dddd, D MMMM Y') }}</h4>
    </div>
