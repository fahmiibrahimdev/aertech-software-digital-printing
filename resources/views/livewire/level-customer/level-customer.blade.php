<div>
    <div class="section-header tw-rounded-lg tw-text-black lg:tw-hidden">
        <h4 class="tw-text-lg">Level Customer</h4>
    </div>

    <div class="section-body lg:tw-mt-[-30px]">
        <div class="tw-mt-[-10px] mb-3">
            <h6 class="section-title tw-text-sm">Data Level Customer</h6>
            <p class="section-lead tw-text-xs">Level Customer berguna untuk menghitung harga jual yang berbeda.</p>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="nama_level" id="nama_level" class="form-control">
                            </div>
                            ...
                            <table class="tw-table-fixed tw-w-full tw-text-black tw-text-sm tw-border-t mt-4">
                                ...
                                <tbody>
                                    ...
                                    <tr class="tw-bg-white text-uppercase tw-border-b hover:tw-bg-gray-50">
                                        <td class="p-3 text-center">{{ $row->nama_level }}</td>
