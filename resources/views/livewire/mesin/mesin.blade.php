<div>
    <div class="section-header tw-rounded-lg tw-text-black lg:tw-hidden">
        <h4 class="tw-text-lg">Mesin</h4>
    </div>

    <div class="section-body lg:tw-mt-[-30px]">
        <div class="tw-mt-[-10px] mb-3">
            <h6 class="section-title tw-text-sm">Data Mesin</h6>
            <p class="section-lead tw-text-xs">Terdapat dua jenis mesin, mesin yang menggunakan ukuran (meter) dan ada
                yang tidak.</p>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group">
                                <label for="kode_printer">Kode Printer</label>
                                <input type="text" wire:model="kode_printer" id="kode_printer" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="nama_printer">Nama Printer</label>
                                <input type="text" wire:model="nama_printer" id="nama_printer" class="form-control">
                            </div>
							<div class="form-group">
                            ...
                            <table class="tw-table-fixed tw-w-full tw-text-black tw-text-sm tw-border-t mt-4">
                                ...
                                <tbody>
                                    ...
                                    <tr class="tw-bg-white tw-border-b hover:tw-bg-gray-50">
                                        <td class="p-3">{{ $row->kode_printer }}</td>
