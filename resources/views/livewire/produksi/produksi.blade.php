<div>
    <div class="section-header tw-rounded-lg tw-text-black lg:tw-hidden">
        <h4 class="tw-text-lg">Produksi</h4>
    </div>

    <div class="section-body lg:tw-mt-[-30px]">
        <div class="tw-mt-[-10px] mb-3">
            <h6 class="section-title tw-text-sm">Data Produksi</h6>
            <p class="section-lead tw-text-xs">Data Produksi didapatkan setelah transaksi.</p>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-success">
                    <div class="card-header">
                        <h4 class="tw-text-xl tw-text-black tw-font-bold tw-font-roboto">Data Produksi</h4>
                    </div>
